...
>(({ className, variant = "none", size = "none", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <IoIosArrowForward className="transition-animation text-gray-100/70 hover:text-white md:size-40" />
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn("flex justify-center relative bottom-10", className)}
      {...props}
    >
